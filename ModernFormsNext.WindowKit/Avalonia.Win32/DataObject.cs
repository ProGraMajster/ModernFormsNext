...
using ModernFormsNext.WindowKit.Win32.MicroCom;
using ModernFormsNext.WindowKit.Platform.Storage;
using ModernFormsNext.WindowKit.Win32.Interop;

using FORMATETC = ModernFormsNext.WindowKit.Win32.Interop.FORMATETC;
using IDataObject = ModernFormsNext.WindowKit.Input.IDataObject;
