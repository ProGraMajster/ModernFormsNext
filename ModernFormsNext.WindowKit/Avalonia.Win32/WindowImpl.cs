...
//using ModernFormsNext.WindowKit.Collections.Pooled;
...
//using ModernFormsNext.WindowKit.Input.TextInput;
using ModernFormsNext.WindowKit.Input;
using ModernFormsNext.WindowKit.Metadata;
//using ModernFormsNext.WindowKit.OpenGL.Egl;
using ModernFormsNext.WindowKit.Platform.Storage;
using ModernFormsNext.WindowKit.Platform;
//using ModernFormsNext.WindowKit.Rendering.Composition;
//using ModernFormsNext.WindowKit.Rendering;
//using ModernFormsNext.WindowKit.Win32.DirectX;
using ModernFormsNext.WindowKit.Win32.Input;
using ModernFormsNext.WindowKit.Win32.Interop;
//using ModernFormsNext.WindowKit.Win32.OpenGl.Angle;
//using ModernFormsNext.WindowKit.Win32.OpenGl;
//using ModernFormsNext.WindowKit.Win32.WinRT.Composition;
using ModernFormsNext.WindowKit.Win32.WinRT;
using static ModernFormsNext.WindowKit.Win32.Interop.UnmanagedMethods;
using ModernFormsNext.WindowKit.Input.Platform;
using System.Diagnostics;

namespace ModernFormsNext.WindowKit.Win32
    {
    /// <summary>
