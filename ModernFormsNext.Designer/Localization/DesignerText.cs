...
public static class DesignerText
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["RefreshToolbox"] = "Refresh",
        ["SearchDocumentOutline"] = "Search document outline",
        ["Delete"] = "Delete",
        ["DesignerSettings"] = "Designer Settings",
        ["Rendering"] = "Rendering",
        ["Language"] = "Language",
        ["ShowToolbar"] = "Show toolbar",
        ["ShowToolboxSearch"] = "Show toolbox search",
        ["ShowDocumentOutlineToolbar"] = "Show outline toolbar",
        ["ShowDocumentOutlineSearch"] = "Show outline search",
        ["AutoSave"] = "Auto-save recovery copies",
    ...
    private static readonly IReadOnlyDictionary<string, string> Polish = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["RefreshToolbox"] = "Odśwież",
        ["SearchDocumentOutline"] = "Szukaj w konspekcie dokumentu",
        ["Delete"] = "Usun",
        ["DesignerSettings"] = "Ustawienia projektanta",
        ["Rendering"] = "Renderowanie",
        ["Language"] = "Jezyk",
        ["ShowToolbar"] = "Pokaz pasek narzedzi",
        ["ShowToolboxSearch"] = "Pokaz wyszukiwarke przybornika",
        ["ShowDocumentOutlineToolbar"] = "Pokaz pasek konspektu",
        ["ShowDocumentOutlineSearch"] = "Pokaz wyszukiwarke konspektu",
        ["AutoSave"] = "Auto-zapis kopii odzyskiwania",
