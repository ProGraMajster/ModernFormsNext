...
using ModernFormsNext.WindowKit.Backend.Tools.MicroComGenerator.Ast;
...
namespace ModernFormsNext.WindowKit.Backend.Tools.MicroComGenerator
{
    public partial class CSharpGen
    {
        ...
        class InterfaceReturnArg : Arg
        {
            ...
            {
                ParseStatement("return ModernFormsNext.WindowKit.Backend.MicroCom.MicroComRuntime.CreateProxyFor<" + InterfaceType + ">(" +
                               PName + ", true);")
            };
            ...
            {
                return ParseExpression($"ModernFormsNext.WindowKit.Backend.MicroCom.MicroComRuntime.GetNativePointer({resultVar}, true)");
            }
        }
        ...
        class InterfaceArg : Arg
        {
            ...
            public override ExpressionSyntax BackMarshalValue()
            {
                return ParseExpression("ModernFormsNext.WindowKit.Backend.MicroCom.MicroComRuntime.CreateProxyFor<" + InterfaceType + ">(" +
                                       Name + ", false)");
            }
            ...
            List<StatementSyntax> vtblCtor, int num)
        {
            ...
            backPreMarshal.Add(
                ParseStatement($"__target = ({iface.Identifier.Text})ModernFormsNext.WindowKit.Backend.MicroCom.MicroComRuntime.GetObjectFromCcw(@this);"));
            ...
            AstInterfaceNode iface)
        {
            ...
            var proxy = ClassDeclaration(proxyClassName)
                ...
                .WithBaseType(inheritsUnknown ?
                    "ModernFormsNext.WindowKit.Backend.MicroCom.MicroComProxyBase" :
            ...
            vtbl = vtbl.WithBaseType(inheritsUnknown ?
                "ModernFormsNext.WindowKit.Backend.MicroCom.MicroComVtblBase" :
            ...
            vtbl = vtbl.AddMembers(
                ...
                .AddMembers(MethodDeclaration(ParseTypeName("void"), "__MicroComModuleInit")
                    ...
                    .WithExpressionBody(ArrowExpressionClause(
                        ParseExpression("ModernFormsNext.WindowKit.Backend.MicroCom.MicroComRuntime.RegisterVTable(typeof(" +
            ...
            proxy = proxy.AddMembers(
                    MethodDeclaration(ParseTypeName("void"), "__MicroComModuleInit")
                        .AddModifiers(Token(SyntaxKind.StaticKeyword), Token(SyntaxKind.InternalKeyword))
                        .WithBody(Block(
                            ParseStatement("ModernFormsNext.WindowKit.Backend.MicroCom.MicroComRuntime.Register(typeof(" +
