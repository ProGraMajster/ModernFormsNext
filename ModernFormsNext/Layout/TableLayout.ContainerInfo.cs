...
internal partial class TableLayout
{
    ...
    internal sealed class ContainerInfo
    {
        ...
        {
            CellBorderWidth = containerInfo.CellBorderWidth;
        ...
        public TableLayoutRowStyleCollection RowStyles {
            get {
                if (_rowStyles is null)
                    _rowStyles = new TableLayoutRowStyleCollection (Container);
            ...
            set {
                ...
                if (_rowStyles is not null)
                    _rowStyles.EnsureOwnership (Container);
            }
        }
        ...
        public TableLayoutColumnStyleCollection ColumnStyles {
            get {
                if (_colStyles is null)
                    _colStyles = new TableLayoutColumnStyleCollection (Container);
            ...
            set {
                ...
                if (_colStyles is not null)
                    _colStyles.EnsureOwnership (Container);
            }
        }
            ...
            get {
                if (!_state[stateChildInfoValid]) {
                    ...
                    for (var i = 0; i < children.Count (); i++) {
                        ...
                        var layoutInfo = GetLayoutInfo (element);
                    ...
                    if (nonParticipatingElements > 0) {
                        var trimmedChildInfo = new LayoutInfo[childInfo.Length - nonParticipatingElements];
        ...
        public bool ChildInfoValid => _state[stateChildInfoValid];
        ...
        public LayoutInfo[] FixedChildrenInfo {
            get {
                ...
                var fixedChildren = new LayoutInfo[_countFixedChildren];
                if (HasChildWithAbsolutePositioning) {
                    var index = 0;
                    for (var i = 0; i < (_childInfo?.Length ?? 0); i++) {
        ...
        public bool HasChildWithAbsolutePositioning => _countFixedChildren > 0;
        ...
        public Size GetCachedPreferredSize (Size proposedConstraints, out bool isValid)
        {
            ...
            if (proposedConstraints.Height == 0 || proposedConstraints.Width == 0) {
                var cachedSize = CommonProperties.xGetPreferredSizeCache (Container);
