...
namespace ModernFormsNext
{
    ...
    public class TabStripItemCollection : Collection<TabStripItem>
    {
        ...
        private int close_button_hovered_index = -1;

        internal int CloseButtonHoveredIndex {
            get => close_button_hovered_index;
            set {
                if (close_button_hovered_index != value) {
                    close_button_hovered_index = value;
                    owner.Invalidate ();
                }
            }
        }
