...
namespace ModernFormsNext
{
    ...
    public static class DrawingExtensions
    {
        ...
        internal static ModernFormsNext.WindowKit.Size ToAvaloniaSize (this Size size) => new ModernFormsNext.WindowKit.Size (size.Width, size.Height);

        internal static ModernFormsNext.WindowKit.PixelPoint ToPixelPoint (this Point point) => new ModernFormsNext.WindowKit.PixelPoint (point.X, point.Y);
    }
}
