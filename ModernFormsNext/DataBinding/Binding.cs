...
namespace ModernFormsNext.DataBinding
{
    ...
    public partial class Binding
    {
        ...
        [FeatureSwitchDefinition("ModernFormsNext.Binding.IsSupported")]
#pragma warning disable IDE0075 // Simplify conditional expression - the simpler expression is hard to read
        internal static bool IsSupported { get; } =
            AppContext.TryGetSwitch("ModernFormsNext.Binding.IsSupported", out bool isSupported)
                ? isSupported
                : true;
#pragma warning restore IDE0075
        ...
        private object? _dsNullValue = BindingValueFormatter.GetDefaultDataSourceNullValue(null);
        ...
        public object? NullValue
        {
            ...
            set
            {
                ...
                if (!Equals(_nullValue, value))
                {
                    ...
                    if (IsBinding && BindingValueFormatter.IsNullData(_bindToObject.GetValue(), _dsNullValue))
                    {
                        PushData();
                    }
                }
            ...
            set
            {
                ...
                if (!Equals(_dsNullValue, value))
                {
                    ...
                    if (IsBinding)
                    {
                        ...
                        if (BindingValueFormatter.IsNullData(dsValue, oldValue))
                        {
                        ...
                        if (BindingValueFormatter.IsNullData(dsValue, value))
                        {
        ...
        private object? GetDataSourceNullValue(Type? type) =>
            _state.HasFlag(BindingStates.DataSourceNullValueSet) ? _dsNullValue : BindingValueFormatter.GetDefaultDataSourceNullValue(type);
        ...
        protected virtual void OnBindingComplete(BindingCompleteEventArgs e)
        {
            if (!_state.HasFlag(BindingStates.InOnBindingComplete))
            {
                ...
                catch (Exception ex) when (!WindowsFormsUtils.IsCriticalException(ex))
                {
        ...
        private object? ParseObject(object? value)
        {
            ...
            if (_state.HasFlag(BindingStates.FormattingEnabled))
            {
                ...
                else
                {
                    ...
                    return BindingValueFormatter.ParseObject(
                        value,
                        type,
        ...
        private object? FormatObject(object? value)
        {
            ...
            if (_state.HasFlag(BindingStates.FormattingEnabled))
            {
                ...
                else
                {
                    ...
                    return BindingValueFormatter.FormatObject(value, type, fieldInfoConverter, _propInfoConverter, _formatString, _formatInfo, _nullValue, _dsNullValue);
                }
            }
            else
            {
        ...
        private void SetPropValue(object? value)
        {
            ...
            try
            {
                bool isNull = value is null || BindingValueFormatter.IsNullData(value, DataSourceNullValue);
                if (isNull)
                {
        ...
        private bool ShouldSerializeDataSourceNullValue() =>
           _state.HasFlag(BindingStates.DataSourceNullValueSet) && _dsNullValue != BindingValueFormatter.GetDefaultDataSourceNullValue(null);
