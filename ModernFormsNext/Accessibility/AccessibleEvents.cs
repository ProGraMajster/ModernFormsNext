...
namespace ModernFormsNext.Accessibility
{
    ...
    public enum AccessibleEvents
    {
        ...
        ///  and will use this at that time. Assistive technologies can use this
        ///  notification to query a non-visual object that describes the sound.
        /// </summary>
        SystemSound = 0x0001,
        ...
        //
        // These values mirror the classic WinEvent identifiers so migrated WinForms code can keep
        // familiar event names. ModernFormsNext shared code raises them through AccessibleObject,
        // and platform backends decide how to translate them to native accessibility APIs.
        ...
        /// <summary>
        /// Sent when a single item becomes selected.
        /// </summary>
        Selection = 0x8006,

        /// <summary>
        /// Sent when an item is added to a multi-selection.
        /// </summary>
        SelectionAdd = 0x8007,

        /// <summary>
        /// Sent when an item is removed from a multi-selection.
        /// </summary>
        SelectionRemove = 0x8008,

        /// <summary>
        /// Sent when the selected items within a container have changed substantially.
        /// </summary>
        ...
        /// <summary>
        /// Sent when an object's screen location or size changes.
        /// </summary>
        LocationChange = 0x800B,

        /// <summary>
        /// Sent when an object's accessible name changes.
        /// </summary>
        NameChange = 0x800C,

        /// <summary>
        /// Sent when an object's accessible description changes.
        /// </summary>
        DescriptionChange = 0x800D,

        /// <summary>
        /// Sent when an object's accessible value changes.
        /// </summary>
        ValueChange = 0x800E,

        /// <summary>
        /// Sent when an object's parent in the accessibility tree changes.
        /// </summary>
        ParentChange = 0x800F,

        /// <summary>
        /// Sent when an object's help text or help topic changes.
        /// </summary>
        HelpChange = 0x8010,

        /// <summary>
        /// Sent when an object's default action description changes.
        /// </summary>
        DefaultActionChange = 0x8011,

        /// <summary>
        /// Sent when an object's keyboard shortcut or accelerator changes.
        /// </summary>
