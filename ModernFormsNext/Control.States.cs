...
public partial class Control
{
    ...
    private protected enum States
    {
        ...
        Enabled                 = 0x00000004,
        TabStop                 = 0x00000008,
        IsDirty                 = 0x00000010,   // ModernFormsNext addition
        IsHovering              = 0x00000020,   // ModernFormsNext addition
        IsImplicitControl       = 0x00000040,   // ModernFormsNext addition
        IsSelected              = 0x00000080,   // ModernFormsNext addition
        //Recreate                = 0x00000010,
        //Modal                   = 0x00000020,
