...
`Directory.Build.props`. Coordinated framework releases use the same version; the 1.11.0 VSIX is
therefore versioned 1.11.0. An independent extension-only patch remains possible when it is
