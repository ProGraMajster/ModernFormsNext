...
| DES-11 | Visual Studio integration | The VSIX HWND adapter still uses reflection for the runtime handle and lacks built-in View Designer/Shift+F7 and dependent-file automation. | Tooling limitation | Medium | [Tracked #71](https://github.com/ProGraMajster/ModernFormsNext/issues/71) | [Visual Studio integration](designer-architecture.md#current-visual-studio-integration-boundaries) |
