...
| Headless testing | `ModernFormsNext.Testing` hosts real layout/input/focus, modal forms/control popups, controlled animation/timer time, scoped existing platform services and optional raster snapshots | Use the [TestHost](../testing/testhost.md) for shared behavior. Issue #64 activation/navigation/virtualization coverage follows #63/#12/#55; native integration remains separate. |
